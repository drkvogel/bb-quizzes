...
def print_section(section, num):
    for i in range(1, num + 1):
        print "    " + section + "_"  + str(i) +  "_wrong    INTEGER2,"
        print "    " + section + "_"  + str(i) +  "_time     INTEGER2,"
        if section == 'br' and i == num:
            print "    " + section + "_"  + str(i) +  "_total    INTEGER1", # take off final comma and no newline (comma after string)
        else:
            print "    " + section + "_"  + str(i) +  "_total    INTEGER1,"
