...
(function () { // Immediately-Invoked Function Expression (IIFE)
    ...
    var WIDTH2X2 = 16; // Width of squares in 2x2 grid is 210px // const?
    var WIDTH3X3 = 16; // Width of squares in 3x3 grid is 170px // const?
    ...
    function fillTile(page, num) {
        var sel, pos;
        pos = (tileWidth(page) * page.images.bottom[num]) + '% 0%';
