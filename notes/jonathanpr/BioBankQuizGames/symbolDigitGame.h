...
private:
	...
	void drawGamePads(bool  isPractice);
	void drawGameText();
	void drawBlankGamePads();
	void drawGamePadColums(int col, bool whiteOut);
	void drawNumberPad();

	void drawBlockImage(String Image, int PosX, int PosY);
	void drawBlock(String Image, TColor PenCol,TColor BrushCol, int PosX, int PosY, bool usePadding = false);
	void drawUserDigit(int i,bool Blank,TColor BrushCol, String theImage);
	void drawUserDigitImage(int i, String theImage);
