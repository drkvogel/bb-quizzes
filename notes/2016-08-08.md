...
This is how to put the envs in the code:
http://inweb/~cp/wiki/doku.php?id=web_site_dev&#cgi_c

    =====  CGI C++ =====

    ** Connecting to a database problem **

    Your CGI connects fine from the command line, but not when used as a CGI through Apache. Make sure you have your env vars set for Ingres.
