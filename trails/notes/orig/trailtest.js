...
var attempt = 0;
var imageList = [
    'TrailMaking/practice_a_gifs/s01.gif',
...
circlesList[0] = ["1", "2", "3", "4", "5", "6", "7", "8"];          // 1-8
for (i = 0; i < 25; i++) circlesList[1][i]          = "" + (i + 1); // 1 - 25
for (i = 0; i < 4; i++)  circlesList[2][2 * i]      = "" + (i + 1); // 1, ?, 2, ?, 3, ?, 4
for (i = 0; i < 4; i++)  circlesList[2][2 * i + 1]  = String.fromCharCode(a.charCodeAt() + i); // 1, A, 2, B, ...
for (i = 0; i < 13; i++) circlesList[3][2 * i]      = "" + (i + 1); // 1, ?, 2, ?, 3, ?, 4, ...
for (i = 0; i < 12; i++) circlesList[3][2 * i + 1]  = String.fromCharCode(a.charCodeAt() + i); // 1, A, 2, B, ...
...
var partaList = ["t01", "t12", "t23", "t34", "t45", "t56", "t67", "t78", "t89",
    "t910", "t1011", "t1112", "t1213", "t1314", "t1415", "t1516", "t1617",
    "t1718", "t1819", "t1920", "t2021", "t2122", "t2223", "t2324", "t2425"
];
var practicebList = ["s_1", "s1a", "sa2", "s2b", "sb3", "s3c", "sc4", "s4d"];
var partbList = ["t_1", "t1a", "ta2", "t2b", "tb3", "t3c", "tc4", "t4d", "td5",
    "t5e", "te6", "t6f", "tf7", "t7g", "tg8", "t8h", "th9", "t9i", "ti10",
    "t10j", "tj11", "t11k", "tk12", "t12l", "tl13"
];
...
function resizeTmt() { //resize images in a function to keep variables local
    ...
    for (var i = 1; i <= 3; i = i + 2) {
        var sizeFactor = ((bodywidth / imgDims[i][0] > bodyheight / imgDims[i][1])
            ? bodyheight / imgDims[i][1] : bodywidth / imgDims[i][1]) * screenFactor;
