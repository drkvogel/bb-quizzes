...
//	std::string	token;
	...
	std::vector<std::string>	head_include;
...
public:
	...
	void 	addHeadInclude( const std::string inc_link );
	void 	addHeadIncludeStyle( const std::string sty );
	void 	htmlBeginDoc( const std::string title );
	void 	htmlBeginDocControl( const std::string title );
	void 	htmlBeginBodyFormat( void );
	void 	htmlEndDoc( void );
	void 	htmlEndBodyFormat( void );
